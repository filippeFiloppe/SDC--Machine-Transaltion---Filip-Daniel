...
def translate_sentence_eng(model, sentence, german, english, device, max_length=50):
...
def bleu_eng(data, model, german, english, device):
    targets = []
    outputs = []
...
def save_checkpoint_eng(state, filename="my_checkpoint_eng.pth.tar"):
    print("=> Saving checkpoint")
    torch.save(state, filename)
